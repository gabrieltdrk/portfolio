...
export function ProjectModal({ project, onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" onClick={onClose}>
      <div className="bg-white p-6 rounded-md w-[90%] max-h-[80%] relative overflow-y-auto max-w-[900px]" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 flex flex-col gap-4 divide-y-4 divide-blue-950">
          ...
          <img className="w-1/2 mx-auto rounded-md" src={project.image} alt={project.title} />
        </div>
      </div>
    </div>
  )
