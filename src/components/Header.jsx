...
export function Header() {
  const linkActive = ({ isActive }) => (isActive ? 'rounded-md underline underline-offset-2 decoration-1 hover:text-gray-200 transition-all hover:animate-pulse decoration-indigo-500' : 'hover:animate-pulse transition-all hover:text-gray-400')
  return (
    <>
